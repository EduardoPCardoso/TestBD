...
public class LugaresVector implements Lugares{
    ...
    public static ArrayList<Lugar> ejemploLugares(){
        ...
        lugares.add(new Lugar("Escuela Politécnica Superior de Gandía",
                ...
                TipoLugar.EDUCACION,962849300, "http://epsg.upv.es" ,
                "Uno de los mejores lugares para formarse.", 3));
        lugares.add(new Lugar("Al de siempre","P.Industrial Junto Molí Nou - 46722, Benifla(Valência)",
                -0.190642, 38.925857,TipoLugar.BAR, 636472405,"",
                "No te pierdas el arroz en calabaza.",3));
        lugares.add(new Lugar("androidcurso.com","ciberespacio",0.0,
                0.0,TipoLugar.EDUCACION,962849300,"http://androidcurso.com",
                "Amplia tus conocimientos sobre Android.",5));
        lugares.add(new Lugar("Barranco del infierno","Vía Verde del río Serpis. Villalonga (Valência)",
                -0.295058,38.867180,TipoLugar.NATUREZA,0,
                "http://sosegaos.blogspot.com.es/2009/02/lorcha-villalonga-via-"+"verde-del-rio.html",
                "Espectacular ruta para bici o andar", 4));
        lugares.add(new Lugar("La Vital","Avda. de La Vital, 0 46701 Gandía (Valência)",
